...
const Vins = () => {
  ...
  const transformProducts = () => {
    ...
    if (byCategory) {
      sortedProducts = sortedProducts?.filter((currentCategory) => {
        if (byCategory === "Rouge") {
          return currentCategory.category === "Rouge";
        } else if (byCategory === "Blanc") {
          return currentCategory.category === "Blanc";
        } else if (byCategory === "Rose") {
          return currentCategory.category === "Rose";
        } else {
          return sortedProducts;
        }
      });
  ...
  return (
    ...
    >
      <Filter filterCategory={transformProducts} />
      <div id="VinsContainer" style={{ width: "80%" }}>
        {byCategory ? (
          <h1
            style={{
