...
import "../Georgie.css";
import Cépage_Rouge from "../../../Icons/cépage-rouge.jpg";
import Cépage_Blanc from "../../../Icons/cépage-blanc.jpg";
import FiberManualRecordRoundedIcon from "@mui/icons-material/FiberManualRecordRounded";
import map_de_georgie from "../../../Icons/map_de_georgie.jpg";
import Vin_De_Georgie from "../../../Icons/vin_de_georgie.jpg";
import Cropped_Vin_de_Georgie from "../../../Icons/cropped-Vin-de-Georgie.jpg";
function Cepages() {
        ...
        <div style={{ backgroundColor: theme === "light" ? "#fff" : "#000" }}>
          ...
          <Container style={{ padding: "50px 0" }}>
            <div className="georgieDescription">
              <p>
                Le caractère unique du vin de Géorgie est conditionné, outre son{" "}
                <NavLink
                ...
                le micro-climat du pays, ses terres et ses techniques viticoles,
                par les variétés endémiques des{" "}
              ...
              <br />
              <p>
                La Géorgie dispose d’un climat idéal pour la production de vin.
                Les étés sont ensoleillés tandis que les hivers sont doux et
                sans gel. Le pays compte également sur de nombreuses sources
                d’eau naturelles qui viennent des montagnes du Caucase et se
                jettent dans les vallées. L’air humide du pays, affecté par la
                mer Noire, aide également les vignes à se développer de manière
                optimale.
              </p>
              <br />
              <p>
              ...
              >
                ...
                >
                  ...
                  <p>
                    ...
                    d’alcool élevés et est souvent mélangé avec d’autres cépages
                    plus doux. Le Saperavi est l’un des principaux cépages
                    utilisés pour la production des vins rouges géorgiens.
                  </p>
                </div>
                <div
                  style={{
                ...
                >
                  ...
                  <p>
                    ...
                    cultivé sur les versants montagneux dominant les rives de la
                    rivière Tskhenistskali, dans la région de Samegrelo en
                    Géorgie occidentale.
                  </p>
                </div>
                <div
                ...
                >
                  ...
                  <p>
                    L’Usakhelauri est un cépage rouge indigène. C’est un raisin
                    d’une qualité exceptionnelle. Cultivé sur les pentes
                    montagneuses de Lechkhumi, le processus de culture est assez
                    complexe et se caractérise par un faible volume de récolte.
                    Seulement trois tonnes de raisins peuvent être récoltés
                    chaque année, les vins d’Usakhelauri sont donc très chers.
                  </p>
                </div>
                <div
                  style={{
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <p>
                    Le Chinuri est cultivé dans la région de Kartli. Il atteint
                    sa pleine maturité fin octobre et est généralement utilisé
                    dans les vins mousseux. Il est souvent mélangé avec du
                    Goruli Mtsvane et de l’Aligoté.
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <p>
                ...
                Kakheti, qui produit soixante-dix pour cent des raisins du Pays.
              </p>
              <p>
